...
for circle_frame in circle_frames:
    print(f'{colors[1]}{circle_frame}',end='\r')
    time.sleep(0.1)
else:
    pass
time.sleep(1)
            ...
            while input_option!=1 and input_option!=2 and input_option!=3 and  input_option!=4:
                ...
                if input_option==1:
                    ...
                    while choose_weapon not in weapons:
                     ...
                     loop_over(sequence='Biomes:',color=colors[-3],delay_time=0.1)
                     generate_options(number_of_options=4,option1=biomes[0],option2=biomes[1],option3=biomes[2],option4=biomes[3])
                     time.sleep(1)
                     choose_biome=int(input(f'{colors[-3]}select biome by number:'))
                    if choose_biome==1:
                        time.sleep(1)
                        playsound(sounds[0])
